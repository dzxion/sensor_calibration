...
for k=2:10
    ...
    [cur_extracted_samples,cur_extracted_intervals] = static_intervals_detector(data_raw,threshold,win,min_size,mean_enable);
    ...
    for i=1:IMU_Sensors_Count
        ...
        acc_calib_params_9 = [acc_calib_params_9;cur_acc_calib_params_9];resnorm_9 = [resnorm_9;cur_resnorm_9];
        acc_calib_data_9 = unbiasNormalize_9(cur_extracted_samples, cur_acc_calib_params_9);
        norm_calib_acc = [];
        for i=1:length(cur_extracted_samples)
            norm_calib_acc(i) = norm(acc_calib_data_9(:,i));
        end
        ...
        acc_calib_params_12 = [acc_calib_params_12;cur_acc_calib_params_12];resnorm_12 = [resnorm_12;cur_resnorm_12];
        acc_calib_data_12 = unbiasNormalize_12(cur_extracted_samples, cur_acc_calib_params_12);
        norm_calib_acc = [];
        for i=1:length(cur_extracted_samples)
            norm_calib_acc(i) = norm(acc_calib_data_12(:,i));
        end
...
%% 陀螺校准
% extracted_samples = [];extracted_intervals = [];
% [extracted_samples,extracted_intervals] = static_intervals_detector(data, threshold, h, min_size, mean_enable)
